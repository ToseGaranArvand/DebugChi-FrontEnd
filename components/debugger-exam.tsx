...
export default function DebuggerExam({ token }: DebuggerExamProps) {
  ...
  const submitAnswers = async () => {
    try {
      ...
      const answersToSubmit = userAnswers.filter(
      ...
      const submitResponse = await perform_post(
        "auths/debugger-exam/submit/",
        submitData,
        token
      );
        ...
        >
          <div className="flex flex-col items-center space-y-8 flex-grow justify-center">
            ...
            <h1 className="text-xl font-bold text-center mt-4">
              آزمون تأیید صلاحیت ویژه متخصصین
            </h1>

            <p className="text-center text-gray-300 max-w-lg text-sm leading-relaxed">
              خوش آمدید! برای شروع ارائه خدمات و کسب درآمد در دیباگچی، یک تست
              کوچک تأیید صلاحیت داریم تا مطمئن شویم می‌توانید بهترین تجربه را
              برای کاربران رقم بزنید.
            </p>
          </div>
          ...
          {examResult ? (
            <>
              ...
              <h1 className="text-xl font-bold text-center text-yellow-400">
                تبریک! شما پذیرفته شدید
              </h1>
              <h2 className="text-lg font-bold text-center text-white">
                شما با موفقیت آزمون را پشت سر گذاشتید!
              </h2>
              <p className="text-center text-gray-300 text-xs leading-relaxed"></p>
              <div className="space-y-3 text-right w-full">
                <h3 className="text-sm font-medium text-white">
                  برای شروع فعالیت، مراحل زیر را دنبال کنید:
                </h3>
                <ol className="list-decimal list-inside space-y-2 text-gray-300 text-xs pr-2">
                  <li>
                    تکمیل اطلاعات حساب کاربری: به صفحه پروفایل خود بروید و
                    اطلاعات شخصی و تخصصی (شامل تجربه کاری، مهارت‌ها و نمونه
                    کارها) را تکمیل کنید.
                  </li>
                  <li>
                    ایجاد اولین خدمت: بخش "ایجاد خدمت جدید" را انتخاب کنید و
                    اولین سرویس برنامه‌نویسی خود را تعریف کنید.
                  </li>
                  <li>
                    {" "}
                    به‌روزرسانی وضعیت آنلاین: وضعیت خود را به "آنلاین" تغییر
                    دهید تا مشتریان بتوانند شما را پیدا کنند.
                  </li>
                </ol>
              </div>
            ...
            <>
              ...
              <h1 className="text-xl font-bold text-center text-red-500">
                متاسفانه شما پذیرفته نشدید
              </h1>
              <h2 className="text-lg font-bold text-center text-white">
                نتیجه آزمون شما
              </h2>
              <p className="text-center text-gray-300 text-xs leading-relaxed">
                متاسفانه شما نتوانستید حداقل امتیاز لازم برای قبولی در آزمون را
                کسب کنید. برای ارائه خدمات در پلتفرم، نیاز است که در آزمون تأیید
                صلاحیت موفق شوید. شما می‌توانید پس از مطالعه بیشتر، مجدداً در
                آزمون شرکت کنید.
              </p>
              <div className="space-y-3 text-right w-full">
                <h3 className="text-sm font-medium text-white">
                  برای آمادگی بهتر در آزمون بعدی:
                </h3>
                <ol className="list-decimal list-inside space-y-2 text-gray-300 text-xs pr-2">
        ...
        <div className="w-[90vw] h-[90vh] bg-[#17151CF7] rounded-2xl mx-auto px-6 py-8 opacity-100 transition-opacity duration-500 overflow-hidden flex items-center justify-center">
          <div className="w-[55vw]">
            ...
            >
              ...
              />
              <p className="text-[#BBBBBB] text-lg leading-relaxed relative z-10">
            ...
            <p className="text-gray-400 text-sm text-center">
              شما {timeLeft} ثانیه وقت دارید. لطفا با دقت ثبت نمایید
            </p>
          </div>
        </div>
      ) : (
